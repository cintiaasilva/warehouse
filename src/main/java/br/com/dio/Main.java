...
public class Main {
    ...
    private static final BasicBasketService basicBasketService = new BasicBasketService(new BasicBasketDAO(), moneyService);
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            switch (option){
                ...
                default -> System.out.println("Opção inválida, escolha as opções informadas no menu.");
            }
        }
    }
